...
if(isset($_POST['insert_product'])){
    ...
    $produc_description=$_POST['product_description'];
    ...
    if($product_title=='' or $product_description=='' or $product_keywords=='' or $product_category=='' or $product_brands=='' or $product_price=='' or $product_image1=='' or $product_image2=='' or $product_image3==''){
        ...
        //insert query
        $insert_products="INSERT INTO `products` (product_title, product_description,product_keywords,category_id,brand_id,product_image1,product_image2,product_image3,product_price,date,status) VALUES('$product_title','$product_description','$product_category','$product_brands','$product_image1','$product_image2','$product_image3','$product_price'NOW(),'$product_status')";
...
<body class="bg-light">
  <div class="container mt-3">
    <h1 class="text-center2">Insert Products</h1>
    <!--form-->
    <form action="" method="post" enctype="multipart/form-data">
        <!--title-->
        <div class="form-outline mb-4 w-50 m-auto">
            <label for="product_title" class="form-label">Product Title</label>
            <input type="text" name="product_title" id="product_title" class="form-control" placeholder="Enter Product Title" autocomplete="off" required="require">
        ...
        <div class="form-outline mb-4 w-50 m-auto">
            ...
            <input type="text" name="descripton" id="description" class="form-control" placeholder="Enter Product description" autocomplete="off" required="require">
        </div>
            ...
            <select name="product_category" id="" class="form-select">
                ...
                <?php
                  ...
                  while($row=mysqli_fetch_assoc($result_query)){
                    ...
                    echo "<option value='$category_id'>category1</option>";
            ...
            <select name="product_brands" id="" class="form-select">
                ...
                <?php
                  ...
                  while($row=mysqli_fetch_assoc($result_query)){
                    ...
                    echo "<option value='$brand_id'>brand1</option>";
                  }
                ?>
            </select>
        </div>
